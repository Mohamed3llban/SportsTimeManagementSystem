"use strict";
var KTCreateTrainer = function () {
    var e, t, i, o, a, r, s = [];
    return {
        init: function () {
            (e = document.querySelector("#kt_modal_create_account")) && new bootstrap.Modal(e), (t = document.querySelector("#kt_create_account_stepper")) && (i = t.querySelector("#kt_create_championships_form"), o = t.querySelector('[data-kt-stepper-action="submit"]'), a = t.querySelector('[data-kt-stepper-action="next"]'), (r = new KTStepper(t)).on("kt.stepper.changed", (function (e) {
                ...
                t ? t.validate().then((function (t) {
                    console.log("validated!"), "Valid" == t ? (e.goNext(), KTUtil.scrollTop()) : Swal.fire({
                        text: "برجاء إدخال الحقول المطلوبة قبل الإنتقال للجزء التالي",
                        icon: "warning",
                        buttonsStyling: !1,
                ...
                fields: {
                    Name: {
                        validators: {
                            notEmpty: {
                                message: "برجاء إدخال الحقل المطلوب"
                            }
                        }
                    },
                    ChampDate: {
                ...
                s[3].validate().then((function (t) {
                    console.log("validated!"), "Valid" == t ? (e.preventDefault(), o.disabled = !0, o.setAttribute("data-kt-indicator", "on"), setTimeout((function () {
                        o.removeAttribute("data-kt-indicator"), o.disabled = !1, r.goNext(), $("#kt_create_championships_form").submit()
                    }), 2e3)) : Swal.fire({
